...
function DefaultLayout() {
    ...
    return (
        <div className="relative flex flex-col overflow-x-hidden bg-gradient-to-r from-[#18162c] to-[#16135e]">
            ...
            {isOpenModal && (
                <div className="fixed top-[50%] left-[50%] z-50 w-[300px] translate-x-[-50%] translate-y-[-50%] bg-[#fff] px-[15px]">
                    ...
                    />
                    <button onClick={() => setIsOpenModal(prev => !prev)} className="mb-8 w-full rounded-r-full rounded-l-full border border-gray-400 bg-[#000]/5 px-4 py-2 text-sm">
                        Tạo mới
                    </button>
                </div>
            )}
